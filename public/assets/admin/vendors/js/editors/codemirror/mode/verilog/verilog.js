...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  var keywords = words(
    ...
    "nand negedge nettype new nexttime nmos nor noshowcancelled not notif0 notif1 null or output packages packed " +
  ...
  */
  ...
  var blockKeywords = words(
    "case checker class clocking config function generate interface module packages" +

...
var JavaScriptHighlightRules = function(options) {
    var keywordMapper = this.createKeywordMapper({
        ...
        "keyword":
            ...
            "class|enum|extends|super|export|implements|private|public|interface|packages|protected|static",
        "storage.type":
...
var ScalaHighlightRules = function() {
    ...
    var keywords = (
            ...
            "override|packages|private|protected|sealed|super|this|trait|type|val|var|with|" +
            "assert|assume|require|print|println|printf|readLine|readBoolean|readByte|readShort|" + // packages scala
            "readChar|readInt|readLong|readFloat|readDouble" // packages scala
    );
    ...
    var langClasses = (
        ...
        "UnsupportedOperationException|Enum|StrictMath|Packages|Compiler|"+
